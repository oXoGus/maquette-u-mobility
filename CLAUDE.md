...
- **Compteurs** : le nombre de chaque `.stat .v` monte de 0 à sa valeur (1,2 s, `cubicBezier(0.22, 1, 0.36, 1)` dans `app.js`, format français conservé) quand la carte devient visible ; pas d'animation avec `?figma` ni `prefers-reduced-motion`.
